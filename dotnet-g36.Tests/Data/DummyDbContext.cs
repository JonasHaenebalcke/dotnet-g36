       ...
       public  Verantwoordelijke organizer1, organizer2;
        public DummyDbContext()
        {
            // Er is maar 1 hfdverantwoordelijke
             admin = new Hoofdverantwoordelijke("Admin", "De Padwin", 0, StatusGebruiker.Actief);
           // Er kunnen veerdere verantwoordelijke zijn
             organizer1 = new Verantwoordelijke("Organiser1", "De SubAdmin1", 1, StatusGebruiker.Actief);
             organizer2 = new Verantwoordelijke("Organiser2", "De SubAdmin2", 2, StatusGebruiker.Actief);
            ...
            Sessie sessie3 = new Sessie(3, admin, organizer1, "Omgaan met frustratie problemen",  "B4.012",
            ...
            Sessie sessie4 = new Sessie(4, admin, organizer2, "Sessie 3D Printing", "B1.027",
                 new DateTime(2019, 12, 24, 7, 30, 0),  new DateTime(2019, 12, 24, 9, 30, 0),
                25, StatusSessie.NietOpen, "Een sessie 3D printing met als gastspreker de geweldige leerkracht Stefaan De Cock", "Stefaan De Cock"
                );

            Sessie sessie5 = new Sessie(5, admin, organizer1, "Sessie Netflix",  "BCON",
            ...
            Sessie sessie6 = new Sessie(6, admin, organizer1, "Sessie DotNet", "BCON",
